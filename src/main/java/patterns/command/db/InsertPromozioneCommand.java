 ...
 * @version 1.0
 */
public final class InsertPromozioneCommand implements DatabaseCommand<Integer> { // Integer = classe wrapper che ha al suo interno solo una variabile di tipo primitivo int
